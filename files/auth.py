#
# destination: /usr/lib/python2.7/dist-packages/deluge/ui/web/auth.py
# HUOM! modded by jakubowy to disable password, do not use unless you have other auth method in place
